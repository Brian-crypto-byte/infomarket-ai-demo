(function () {
  ...
  const en = {
    ...
    'vault.product': 'INFO Products', 'vault.title': 'INFO Vault',
    'vault.subtitle': 'Deposit idle USDT into fixed-term vault plans. Funds stay in the internal ledger and unlock after 7, 15, 30, 60, or 180 days.',
    ...
    'insurance.eyebrow': 'Alpha Insurance', 'insurance.title': 'INFO Insurance',
    'insurance.subtitle': 'Buy optional cover with a prediction order. If the position has a verified loss, the system creates an internal payout node and releases claimable USDT by insurance-pool schedule.',
  ...
  const dict = {
    ...
    'zh-CN': { ...en,
      ...
      'vault.product': 'INFO 产品', 'vault.title': 'INFO 金库',
      'vault.subtitle': '将闲置 USDT 存入固定期限金库计划。资金保留在内部账本中，并在 7、15、30、60 或 180 天锁仓期结束后解锁。',
      ...
      'insurance.eyebrow': 'Alpha 保险', 'insurance.title': 'INFO 保险',
      'insurance.subtitle': '下单时可选择购买保险。若持仓结算为有效亏损，系统会生成内部赔付节点，并按保险池计划释放可领取 USDT。',
  ...
  const accountTranslations = {
    en: {
      'account.eyebrow': 'Account overview', 'account.title': 'Dashboard',
      ...
      'assets.eyebrow': 'Internal ledger', 'assets.title': 'Assets',
      'assets.subtitle': 'On-chain only handles USDT deposits and withdrawals. Trading freezes, settlement, vault balances, claimable payouts, and locked INF Credits live in the internal ledger.',
      ...
      'positions.eyebrow': 'Prediction orders', 'positions.title': 'Positions',
      ...
      'rewards.eyebrow': 'INF Credits', 'rewards.title': 'Rewards',
