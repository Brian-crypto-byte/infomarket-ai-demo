(function () {
  ...
  const en = {
    ...
    'vault.product': '', 'vault.title': 'Agent Details',
  ...
  const dict = {
    ...
    'zh-CN': { ...en,
      ...
      'vault.product': '', 'vault.title': 'Agent 详情',
  ...
  const greenxOverrides = {
    en: {
      ...
      'account.vaultHint': 'Upgrade lobster level with USDT deposits', 'account.insuranceHint': 'Use Lobster Token for cover',
      'vault.title': 'Agent Details', 'vault.subtitle': 'Deploy USDT to an AI prediction agent. The agent evaluates event markets, places risk-controlled prediction orders, and returns realized yield to the vault.',
    ...
    'zh-CN': {
      ...
      'account.vaultHint': '用 USDT 存款升级龙虾等级', 'account.insuranceHint': '使用 Lobster Token 购买保障',
      'vault.title': 'Agent 详情', 'vault.subtitle': '将 USDT 部署给 AI 预测 Agent。Agent 会分析事件预测市场，执行风控下注，并将已实现收益回到金库。',
