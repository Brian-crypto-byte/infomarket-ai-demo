(function () {
  ...
  const en = {
    ...
    'vault.product': '', 'vault.title': 'GreenX Vault',
    'vault.subtitle': 'Deposit USDT to upgrade your GreenX lobster level, choose a fixed lock term, and use AI recommendations to balance yield and liquidity.',
    'vault.aiOptimized': 'AI optimized', 'vault.myVault': 'My vault', 'vault.accruedYield': 'Accrued yield',
    'vault.greenxLevel': 'Lobster level', 'vault.dailyYield': 'Daily yield', 'vault.lobsterStake': 'Staked Lobster',
    ...
    'vault.marketSeparate': 'Prediction market', 'vault.marketSeparateValue': 'USDT trading stays independent from vault level',
    'vault.lobsterBoost': 'Lobster Token stake', 'vault.lobsterBoostValue': 'Accelerates level validity or extends duration',
    ...
    'vault.aiRecommendation': 'AI recommendation', 'vault.aiTerm7': '7D is best for short liquidity tests with 0.5% fixed daily yield.',
    'vault.aiTerm30': '30D balances fixed daily yield with better liquidity.',
    'vault.aiTerm90': '90D suits users seeking higher fixed daily yield while keeping quarterly flexibility.',
    'vault.aiTerm180': '180D is suitable for users targeting higher lobster-level stability.',
    'vault.aiTerm360': '360D maximizes fixed daily yield and long-term lobster-level validity.',
  ...
  const dict = {
    ...
    'zh-CN': { ...en,
      ...
      'vault.product': '', 'vault.title': 'GreenX 金库',
      'vault.subtitle': '存入 USDT 升级 GreenX 龙虾等级，选择固定锁仓期限，并用 AI 推荐平衡收益和流动性。',
      'vault.aiOptimized': 'AI 推荐', 'vault.myVault': '我的金库', 'vault.accruedYield': '累计收益',
      'vault.greenxLevel': '龙虾等级', 'vault.dailyYield': '日化收益', 'vault.lobsterStake': '质押 Lobster',
      ...
      'vault.marketSeparate': '预测市场', 'vault.marketSeparateValue': 'USDT 交易与金库等级完全独立',
      'vault.lobsterBoost': 'Lobster Token 质押', 'vault.lobsterBoostValue': '加速等级或延长有效期',
      ...
      'vault.aiRecommendation': 'AI 推荐', 'vault.aiTerm7': '7 天适合短期流动性测试，固定日化 0.5%。',
      'vault.aiTerm30': '30 天在固定日化收益和流动性之间更均衡。',
      'vault.aiTerm90': '90 天适合追求更高固定日化，同时保留季度灵活性的用户。',
      'vault.aiTerm180': '180 天适合追求更稳定龙虾等级有效期的用户。',
      'vault.aiTerm360': '360 天最大化固定日化收益和长期龙虾等级有效期。',
  ...
  const greenxOverrides = {
    en: {
      ...
      'account.vaultHint': 'Upgrade lobster level with USDT deposits', 'account.insuranceHint': 'Use Lobster Token for cover',
      'vault.title': 'GreenX Vault', 'vault.subtitle': 'Deposit USDT to upgrade your GreenX lobster level, choose a fixed lock term, and use AI recommendations to balance yield and liquidity.',
      'vault.termsValue': '7 / 30 / 90 / 180 / 360 days',
      'vault.ledgerDeposit': 'Vault deposit', 'vault.ledgerWithdraw': 'Vault withdraw',
      'vault.depositNote': 'Locks USDT for {days} days in GreenX Vault.', 'vault.withdrawNote': 'Withdraws unlocked USDT from GreenX Vault back to available balance.',
    ...
    'zh-CN': {
      ...
      'account.vaultHint': '用 USDT 存款升级龙虾等级', 'account.insuranceHint': '使用 Lobster Token 购买保障',
      'vault.title': 'GreenX 金库', 'vault.subtitle': '存入 USDT 升级 GreenX 龙虾等级，选择固定锁仓期限，并用 AI 推荐平衡收益和流动性。',
      'vault.termsValue': '7 / 30 / 90 / 180 / 360 天',
      'vault.ledgerDeposit': '金库存入', 'vault.ledgerWithdraw': '金库取出',
      'vault.depositNote': '将 USDT 锁定 {days} 天并存入 GreenX 金库。',
      'vault.withdrawNote': '将已解锁 USDT 从 GreenX 金库转回可用余额。',
