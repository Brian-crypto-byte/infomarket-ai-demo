(function () {
  ...
  accountTranslations.ja = Object.assign({}, accountTranslations.en, { 'account.title': 'アカウント概要', 'assets.title': '資産', 'positions.title': 'ポジション', 'rewards.title': '報酬', 'account.eyebrow': '', 'assets.eyebrow': '', 'positions.eyebrow': '予測注文', 'account.depositWithdraw': '入金 / 出金', 'positions.continueTrading': '取引を続ける', 'rewards.claimUnlocked': '解除済み INF を請求', 'account.currentPositions': '現在のポジション', 'account.quickActions': 'クイック操作', 'assets.deposit': 'USDT 入金', 'assets.withdrawal': 'USDT 出金', 'assets.ledgerEntries': '資産履歴', 'assets.withdrawStatus': '出金ステータス', 'rewards.unlockConditions': '解除条件', 'rewards.ledger': '報酬履歴', 'rewards.tasks': 'タスク', 'table.market': 'マーケット', 'table.pick': '選択', 'table.amount': '金額', 'table.status': 'ステータス', 'common.copy': 'コピー', 'common.copied': 'コピー済み', 'common.done': '完了', 'common.open': '未完了' });
  accountTranslations.ko = Object.assign({}, accountTranslations.en, { 'account.title': '계정 개요', 'assets.title': '자산', 'positions.title': '포지션', 'rewards.title': '리워드', 'account.eyebrow': '', 'assets.eyebrow': '', 'positions.eyebrow': '예측 주문', 'account.depositWithdraw': '입금 / 출금', 'positions.continueTrading': '거래 계속하기', 'rewards.claimUnlocked': '잠금 해제 INF 수령', 'account.currentPositions': '현재 포지션', 'account.quickActions': '빠른 작업', 'assets.deposit': 'USDT 입금', 'assets.withdrawal': 'USDT 출금', 'assets.ledgerEntries': '자산 내역', 'assets.withdrawStatus': '출금 상태', 'rewards.unlockConditions': '잠금 해제 조건', 'rewards.ledger': '리워드 내역', 'rewards.tasks': '작업', 'table.market': '마켓', 'table.pick': '선택', 'table.amount': '금액', 'table.status': '상태', 'common.copy': '복사', 'common.copied': '복사됨', 'common.done': '완료', 'common.open': '미완료' });
  accountTranslations.vi = Object.assign({}, accountTranslations.en, { 'account.title': 'Tổng quan tài khoản', 'assets.title': 'Tài sản', 'positions.title': 'Vị thế', 'rewards.title': 'Thưởng', 'account.eyebrow': '', 'assets.eyebrow': '', 'positions.eyebrow': 'Lệnh dự đoán', 'account.depositWithdraw': 'Nạp / Rút', 'positions.continueTrading': 'Tiếp tục giao dịch', 'rewards.claimUnlocked': 'Nhận INF đã mở khóa', 'account.currentPositions': 'Vị thế hiện tại', 'account.quickActions': 'Thao tác nhanh', 'assets.deposit': 'Nạp USDT', 'assets.withdrawal': 'Rút USDT', 'assets.ledgerEntries': 'Lịch sử tài sản', 'assets.withdrawStatus': 'Trạng thái rút', 'rewards.unlockConditions': 'Điều kiện mở khóa', 'rewards.ledger': 'Sổ thưởng', 'rewards.tasks': 'Nhiệm vụ', 'table.market': 'Thị trường', 'table.pick': 'Lựa chọn', 'table.amount': 'Số tiền', 'table.status': 'Trạng thái', 'common.copy': 'Sao chép', 'common.copied': 'Đã sao chép', 'common.done': 'Hoàn tất', 'common.open': 'Chưa xong' });
  accountTranslations.id = Object.assign({}, accountTranslations.en, { 'account.title': 'Ringkasan akun', 'assets.title': 'Aset', 'positions.title': 'Posisi', 'rewards.title': 'Reward', 'account.eyebrow': '', 'assets.eyebrow': '', 'positions.eyebrow': 'Order prediksi', 'account.depositWithdraw': 'Deposit / Tarik', 'positions.continueTrading': 'Lanjut trading', 'rewards.claimUnlocked': 'Klaim INF terbuka', 'account.currentPositions': 'Posisi saat ini', 'account.quickActions': 'Aksi cepat', 'assets.deposit': 'Deposit USDT', 'assets.withdrawal': 'Penarikan USDT', 'assets.ledgerEntries': 'Riwayat aset', 'assets.withdrawStatus': 'Status penarikan', 'rewards.unlockConditions': 'Syarat unlock', 'rewards.ledger': 'Buku reward', 'rewards.tasks': 'Tugas', 'table.market': 'Pasar', 'table.pick': 'Pilihan', 'table.amount': 'Jumlah', 'table.status': 'Status', 'common.copy': 'Salin', 'common.copied': 'Disalin', 'common.done': 'Selesai', 'common.open': 'Belum selesai' });
