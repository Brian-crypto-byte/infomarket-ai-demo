(function () {
  ...
  const en = {
    ...
    'auth.subtitle': 'Use the same GreenX Solana wallet to sign in, claim Lobster Token airdrops, sync lobster level, and trade prediction markets with USDT.',
    ...
    'auth.devNote': 'Preview access simulates GreenX wallet detection, Lobster Token airdrop eligibility, and wallet signatures. Production will verify wallet ownership before deposits, withdrawals, claims, and trading.',
    ...
    'account.title': 'Account overview', 'account.subtitle': 'Manage USDT balances, GreenX lobster level, Lobster Token consumption, vault deposits, Alpha Insurance, and prediction positions.',
    'account.depositWithdraw': 'Deposit / Withdraw', 'account.available': 'Available USDT', 'account.greenxLevel': 'GreenX lobster level',
    'account.lobsterToken': 'Lobster Token', 'account.vaultBalance': 'Vault balance', 'account.greenxTitle': 'GreenX wallet sync',
    'account.synced': 'Synced', 'account.wallet': 'Wallet', 'account.airdrop': 'Lobster airdrop', 'account.claimReady': 'Ready to claim',
    'account.nextLevel': 'Next level', 'account.claimLobster': 'Claim Lobster Token', 'account.aiTitle': 'AI prediction assistant',
    'account.referenceOnly': 'Reference only', 'account.aiMarket': 'Market signal', 'account.aiMarketValue': 'Football volatility is moderate; prefer smaller stake sizes.',
    'account.aiVault': 'Vault signal', 'account.aiVaultValue': '30-day lock has the best liquidity-adjusted return today.',
    'account.currentPositions': 'Current positions', 'account.lobsterConsumption': 'Lobster Token usage', 'account.feeDiscount': 'Trading fee discount',
    'account.enabled': 'Enabled', 'account.insurancePremium': 'Insurance premium', 'account.lobsterPreferred': 'Lobster preferred',
    'account.vaultAcceleration': 'Vault acceleration', 'account.consumedToday': 'Consumed today', 'account.quickActions': 'Quick actions',
    'account.assetsHint': 'Deposit, withdraw, and USDT balances', 'account.positionsHint': 'Orders, PnL, and settlement status',
    'account.vaultHint': 'Upgrade lobster level with USDT deposits', 'account.insuranceHint': 'Use Lobster Token for cover',
    'account.healthy': 'Healthy', 'account.openInsurance': 'Open insurance nodes',
    'vault.product': '', 'vault.title': 'Vault Details',
    'vault.subtitle': 'Deploy USDT to an AI prediction agent. The agent evaluates event markets, places risk-controlled prediction orders, and returns realized yield to the vault.',
    'vault.aiOptimized': 'AI event strategy', 'vault.myVault': 'Deployed capital', 'vault.accruedYield': 'Accrued yield',
    'vault.greenxLevel': 'Lobster level', 'vault.dailyYield': 'Agent yield today', 'vault.lobsterStake': 'Strategy confidence',
    'vault.infBoost': 'Lobster Token boost', 'vault.tvl': 'Vault TVL', 'vault.yieldCurve': 'Yield curve',
    'vault.dailySettlement': 'Daily realized PnL', 'vault.rules': 'AI vault rules', 'vault.terms': 'Vault terms',
    'vault.yieldSettlement': 'Yield settlement', 'vault.withdraw': 'Withdraw', 'vault.afterLock': 'After lock expires',
    'vault.levelRule': 'Level rule', 'vault.levelRuleValue': 'Cumulative valid USDT deposits upgrade lobster level',
    'vault.marketSeparate': 'Prediction market', 'vault.marketSeparateValue': 'AI strategy participates with vault capital, user manual trading stays independent',
    'vault.lobsterBoost': 'Lobster Token stake', 'vault.lobsterBoostValue': 'Improves agent priority and fee discount',
    'vault.creditsBoost': 'Lobster Token boost', 'vault.longerBoost': 'Longer term, higher boost',
    'vault.ledger': 'Vault ledger', 'vault.manage': 'Deploy AI agent', 'vault.deposit': 'Deploy',
    'vault.withdrawAction': 'Withdraw', 'vault.lockTerm': 'Lock term', 'vault.amount': 'Amount',
    'vault.confirmDeposit': 'Deploy to AI agent', 'vault.confirmWithdraw': 'Withdraw',
    'vault.depositNote': 'Deploys USDT to the AI prediction agent for a {days}-day cycle.',
    'vault.withdrawNote': 'Withdraws unlocked USDT from the AI Agent Vault back to available balance.',
    ...
    'vault.aiRecommendation': 'Agent recommendation', 'vault.aiTerm7': '7D cycle is suitable for high-frequency event prediction and fast capital rotation.',
    'vault.aiTerm30': '30D cycle lets the agent run across sports, crypto, and news event windows with balanced liquidity.',
    'vault.aiTerm90': '90D cycle gives the agent more time for multi-event portfolio rebalancing.',
    'vault.aiTerm180': '180D cycle suits users who want the agent to compound across longer market seasons.',
    'vault.aiTerm360': '360D cycle maximizes agent continuity and long-horizon prediction-market participation.',
    'vault.agentName': 'A3 Flexible Prediction Strategy T7', 'vault.agentDesc': 'Multi-market AI strategy for football, crypto, esports, and news event prediction.',
    'vault.running': 'Running', 'vault.guardApr': 'Guarded APR', 'vault.cycle': 'Cycle', 'vault.addDeployment': 'Add deployment',
    'vault.deployed': 'Deployed', 'vault.monitor': 'Live monitor', 'vault.records': 'Run records',
    'vault.agentCapital': 'Agent capital', 'vault.marketScope': 'Market scope', 'vault.marketScopeValue': 'Football / Crypto / Esports / News',
    'vault.riskControl': 'Risk control', 'vault.riskControlValue': 'Single market exposure capped at 8%',
    'vault.settlementRule': 'Settlement', 'vault.settlementRuleValue': 'Realized PnL settles to vault daily',
    'vault.levelMap': 'Lobster level map', 'vault.midLobster': 'Mid Lobster · +25%', 'vault.bigLobster': 'Big Lobster · +50%',
    'vault.royalLobster': 'Royal Lobster · +80%', 'vault.kingLobster': 'King Lobster · +130%',
    'vault.smallLobsterShort': 'Small Lobster', 'vault.midLobsterShort': 'Mid Lobster', 'vault.bigLobsterShort': 'Big Lobster',
    'vault.royalLobsterShort': 'Royal Lobster', 'vault.kingLobsterShort': 'King Lobster',
    'insurance.eyebrow': '', 'insurance.title': 'Alpha Insurance',
  ...
  const dict = {
    ...
    'zh-CN': { ...en,
      ...
      'auth.subtitle': '使用 GreenX 同一个 Solana 钱包登录，领取 Lobster Token 空投，同步龙虾等级，并用 USDT 参与预测交易。',
      ...
      'auth.walletNote': '连接钱包用于充值、提现、GreenX 同步和 Lobster Token 领取。',
      'auth.devNote': '当前预览会模拟 GreenX 钱包检测、Lobster Token 空投资格和钱包签名。正式环境会在充值、提现、领取和交易前验证钱包所有权。',
      ...
      'account.title': '账户总览', 'account.subtitle': '管理 USDT 余额、GreenX 龙虾等级、Lobster Token 消耗、金库存款、Alpha 保险和预测持仓。',
      'account.depositWithdraw': '充值 / 提现', 'account.available': '可用 USDT', 'account.greenxLevel': 'GreenX 龙虾等级',
      'account.lobsterToken': 'Lobster Token', 'account.vaultBalance': '金库余额', 'account.greenxTitle': 'GreenX 钱包同步',
      'account.synced': '已同步', 'account.wallet': '钱包', 'account.airdrop': '龙虾空投', 'account.claimReady': '可领取',
      'account.nextLevel': '下一等级', 'account.claimLobster': '领取 Lobster Token', 'account.aiTitle': 'AI 预测助手',
      'account.referenceOnly': '仅供参考', 'account.aiMarket': '市场信号', 'account.aiMarketValue': '足球波动中等，建议控制单笔下注金额。',
      'account.aiVault': '金库信号', 'account.aiVaultValue': '今日 30 天锁仓在收益和流动性之间更均衡。',
      'account.currentPositions': '当前持仓', 'account.lobsterConsumption': 'Lobster Token 消耗', 'account.feeDiscount': '交易手续费折扣',
      'account.enabled': '已开启', 'account.insurancePremium': '保险保费', 'account.lobsterPreferred': '优先使用 Lobster',
      'account.vaultAcceleration': '金库升级加速', 'account.consumedToday': '今日消耗', 'account.quickActions': '快捷操作',
      'account.assetsHint': '充值、提现和 USDT 余额', 'account.positionsHint': '订单、盈亏和结算状态',
      'account.vaultHint': '用 USDT 存款升级龙虾等级', 'account.insuranceHint': '使用 Lobster Token 购买保障',
      'account.healthy': '健康', 'account.openInsurance': '打开保险节点',
      'vault.product': '', 'vault.title': '金库详情',
      'vault.subtitle': '将 USDT 部署给 AI 预测 Agent。Agent 会分析事件预测市场，执行风控下注，并将已实现收益回到金库。',
      'vault.aiOptimized': 'AI 事件策略', 'vault.myVault': '已部署本金', 'vault.accruedYield': '累计收益',
      'vault.greenxLevel': '龙虾等级', 'vault.dailyYield': '今日 Agent 收益', 'vault.lobsterStake': '策略置信度',
      'vault.infBoost': 'Lobster Token 加成', 'vault.tvl': '金库 TVL', 'vault.yieldCurve': '收益曲线',
      'vault.dailySettlement': '每日已实现收益', 'vault.rules': 'AI 金库规则', 'vault.terms': '锁仓期限',
      'vault.yieldSettlement': '收益结算', 'vault.withdraw': '取出', 'vault.afterLock': '锁仓到期后可取出',
      'vault.levelRule': '等级规则', 'vault.levelRuleValue': '累计有效 USDT 存入金额自动升级龙虾等级',
      'vault.marketSeparate': '预测市场', 'vault.marketSeparateValue': 'AI 策略使用金库资金参与，用户手动交易保持独立',
      'vault.lobsterBoost': 'Lobster Token 质押', 'vault.lobsterBoostValue': '提升 Agent 优先级和手续费折扣',
      'vault.creditsBoost': 'Lobster Token 加成', 'vault.longerBoost': '期限越长，加成越高',
      'vault.ledger': '金库流水', 'vault.manage': '部署 AI Agent', 'vault.deposit': '部署',
      'vault.withdrawAction': '取出', 'vault.lockTerm': '锁仓期限', 'vault.amount': '金额',
      'vault.confirmDeposit': '部署到 AI Agent', 'vault.confirmWithdraw': '取出',
      'vault.depositNote': '将 USDT 部署给 AI 预测 Agent，运行 {days} 天周期。',
      'vault.withdrawNote': '将已解锁 USDT 从 AI Agent 金库转回可用余额。',
      ...
      'vault.aiRecommendation': 'Agent 推荐', 'vault.aiTerm7': '7 天周期适合高频事件预测和快速资金轮动。',
      'vault.aiTerm30': '30 天周期可覆盖体育、加密和新闻事件窗口，收益和流动性更均衡。',
      'vault.aiTerm90': '90 天周期让 Agent 有更多时间做多事件组合再平衡。',
      'vault.aiTerm180': '180 天周期适合让 Agent 跨赛季和热点周期复利运行。',
      'vault.aiTerm360': '360 天周期最大化 Agent 连续运行和长期预测市场参与。',
      'vault.agentName': 'A3 灵活事件预测策略 T7', 'vault.agentDesc': '面向足球、加密、电竞和新闻事件预测的多市场 AI 策略。',
      'vault.running': '运行中', 'vault.guardApr': '保守 APR', 'vault.cycle': '循环周期', 'vault.addDeployment': '增加部署',
      'vault.deployed': '已部署', 'vault.monitor': '实时监控', 'vault.records': '运行记录',
      'vault.agentCapital': 'Agent 本金', 'vault.marketScope': '市场范围', 'vault.marketScopeValue': '足球 / 加密 / 电竞 / 新闻',
      'vault.riskControl': '风控规则', 'vault.riskControlValue': '单个市场敞口不超过 8%',
      'vault.settlementRule': '收益结算', 'vault.settlementRuleValue': '已实现 PnL 每日结算到金库',
      'vault.levelMap': '龙虾等级映射', 'vault.midLobster': '中龙虾 · +25%', 'vault.bigLobster': '大龙虾 · +50%',
      'vault.royalLobster': '皇龙虾 · +80%', 'vault.kingLobster': '帝王龙虾 · +130%',
      'vault.smallLobsterShort': '小龙虾', 'vault.midLobsterShort': '中龙虾', 'vault.bigLobsterShort': '大龙虾',
      'vault.royalLobsterShort': '皇龙虾', 'vault.kingLobsterShort': '帝王龙虾',
      'insurance.eyebrow': '', 'insurance.title': 'Alpha 保险',
    ...
    ja: { ...en,
      ...
      'auth.loginSignup': 'ログイン / 登録', 'auth.title': 'infomarket.ai にログイン', 'auth.subtitle': 'メールで取引用アカウントを作成するか、ウォレットを接続して USDT の入出金と Lobster Token の受け取りを行います。',
    ...
    ko: { ...en,
      ...
      'auth.loginSignup': '로그인 / 가입', 'auth.title': 'infomarket.ai 로그인', 'auth.subtitle': '이메일로 거래 계정을 만들거나 지갑을 연결해 USDT 입출금과 Lobster Token 수령을 진행하세요.',
    ...
    vi: { ...en,
      ...
      'auth.loginSignup': 'Đăng nhập / Đăng ký', 'auth.title': 'Đăng nhập infomarket.ai', 'auth.subtitle': 'Dùng email để tạo tài khoản giao dịch hoặc kết nối ví để nạp, rút USDT và nhận Lobster Token.',
    ...
    id: { ...en,
      ...
      'auth.loginSignup': 'Masuk / Daftar', 'auth.title': 'Masuk ke infomarket.ai', 'auth.subtitle': 'Gunakan email untuk membuat akun trading atau hubungkan wallet untuk deposit, penarikan USDT, dan klaim Lobster Token.',
  ...
  const orderTranslations = {
    en: {
      ...
      'order.lobsterReward': 'Lobster Token',
  ...
  const accountTranslations = {
    en: {
      ...
      'account.subtitle': 'Manage USDT balances, prediction positions, GreenX Vault, Alpha Insurance, and Lobster Token unlock progress.',
      'account.depositWithdraw': 'Deposit / Withdraw', 'account.availableBalance': 'Available balance',
      'account.frozenOrders': 'Frozen in orders', 'account.vaultBalance': 'Vault balance', 'account.lobsterReward': 'Lobster Token',
      'account.currentPositions': 'Current positions', 'account.viewAll': 'View all', 'account.unlock': 'Lobster Token unlock',
      ...
      'account.rewardsDesc': 'Mining, tasks, and referrals', 'account.vaultDesc': 'USDT yield with Lobster Token boost',
      ...
      'rewards.eyebrow': '', 'rewards.title': 'Lobster Rewards',
      'rewards.subtitle': 'Trading mining, vault boost, Alpha Insurance boost, referrals, and task rewards are aggregated here. Lobster Token are locked until unlock conditions are met.',
      'rewards.claimUnlocked': 'Claim Lobster Token', 'rewards.totalCredits': 'Total Lobster Token', 'rewards.unlocked': 'Unlocked',
      ...
      'table.lobsterReward': 'Lobster Token', 'table.insurance': 'Insurance', 'table.rule': 'Rule', 'table.source': 'Source',
      'table.credits': 'Lobster Token', 'table.multiplier': 'Multiplier',
      ...
      'state.noRewards': 'No rewards yet. Trade, deposit into vault, or invite users to earn Lobster Token.',
      ...
      'reward.orderReward': 'Order reward', 'reward.vaultBoost': 'GreenX Vault boost', 'reward.insuranceBoost': 'Alpha Insurance boost',
      ...
      'task.depositVault': 'Deposit into GreenX Vault', 'task.useInsurance': 'Use Alpha Insurance',
      'task.inVault': 'in vault', 'task.insuranceNodes': 'insurance nodes', 'common.copy': 'Copy', 'common.copied': 'Copied',
      'common.done': 'Done', 'common.open': 'Open', 'rewards.claimQueued': 'Lobster Token claim queued',
      'static.activeDaysValue': '18 / 30 days', 'static.validRefsValue': '7 / 10 users'
    },
    'zh-CN': {
      'account.eyebrow': '', 'account.title': '账户总览', 'account.subtitle': '管理 USDT 余额、预测持仓、GreenX 金库、Alpha 保险和 Lobster Token 解锁进度。', 'account.depositWithdraw': '充值 / 提现', 'account.availableBalance': '可用余额', 'account.frozenOrders': '订单冻结', 'account.vaultBalance': '金库余额', 'account.lobsterReward': 'Lobster Token', 'account.currentPositions': '当前持仓', 'account.viewAll': '查看全部', 'account.unlock': 'Lobster Token 解锁', 'account.cumulativeVolume': '累计交易量', 'account.activeDays': '活跃天数', 'account.vaultLock': '金库锁仓', 'account.unlockableAmount': '可解锁额度', 'account.quickActions': '快捷操作', 'account.assetsDesc': '充值、提现和内部余额', 'account.positionsDesc': '订单、盈亏和结算状态', 'account.rewardsDesc': '挖矿、任务和邀请', 'account.vaultDesc': 'USDT 收益与 Lobster Token 加成', 'account.insuranceDesc': '赔付节点和保险保障', 'account.activeCover': '生效保额', 'account.poolHealth': '保险池状态', 'account.healthy': '健康', 'account.openInsuranceNodes': '打开保险节点',
      ...
      'rewards.eyebrow': '', 'rewards.title': 'Lobster Token 奖励', 'rewards.subtitle': '交易挖矿、金库加成、Alpha 保险加成、邀请和任务奖励都会汇总在这里。Lobster Token 在满足解锁条件前保持锁定。', 'rewards.claimUnlocked': '领取 Lobster Token', 'rewards.totalCredits': 'Lobster Token 总额', 'rewards.unlocked': '已解锁', 'rewards.todayAdded': '今日新增', 'rewards.referralRebate': '邀请返佣', 'rewards.unlockConditions': '解锁条件', 'rewards.tradingVolume': '累计交易量', 'rewards.vaultDuration': '金库余额时长', 'rewards.validReferrals': '有效邀请', 'rewards.ledger': '奖励流水', 'rewards.openPositions': '打开持仓', 'rewards.tasks': '任务', 'rewards.miningWeights': '挖矿权重', 'rewards.tradingFee': '交易手续费', 'rewards.marketActivity': '市场活跃度', 'rewards.insuranceParticipation': '保险参与', 'rewards.referralLink': '邀请链接', 'rewards.referralNote': '被邀请用户完成充值和首笔交易后，才计为有效邀请。', 'rewards.leaderboard': '排行榜', 'rewards.you': '你',
      'table.market': '市场', 'table.pick': '选择', 'table.amount': '金额', 'table.potentialReturn': '潜在回报', 'table.status': '状态', 'table.type': '类型', 'table.note': '备注', 'table.time': '时间', 'table.lobsterReward': 'Lobster Token', 'table.insurance': '保险', 'table.rule': '规则', 'table.source': '来源', 'table.credits': 'Lobster Token', 'table.multiplier': '倍数',
      'state.noActivePositions': '暂无进行中的持仓。打开市场并完成第一笔下单。', 'state.noPositions': '暂无{status}持仓。请从市场页下单。', 'state.noLedger': '暂无账本流水。充值或下单后会显示在这里。', 'state.noWithdrawals': '暂无提现申请。', 'state.noRewards': '暂无奖励。交易、存入金库或邀请用户可获得 Lobster Token。',
      ...
      'rule.openMarket': '可交易市场', 'rule.noSellBeforeSettlement': '结算前不可卖出', 'reward.orderReward': '订单奖励', 'reward.vaultBoost': 'GreenX 金库加成', 'reward.insuranceBoost': 'Alpha 保险加成', 'reward.referralRebate': '邀请返佣', 'reward.daily': '每日', 'reward.campaign': '活动', 'ledger.tradingMiningReward': '交易挖矿奖励', 'task.firstOrder': '完成首笔预测订单', 'task.tradeVolume': '交易量达到 10,000 USDT', 'task.depositVault': '存入 GreenX 金库', 'task.useInsurance': '使用 Alpha 保险', 'task.inVault': '在金库中', 'task.insuranceNodes': '个保险节点', 'common.copy': '复制', 'common.copied': '已复制', 'common.done': '已完成', 'common.open': '未完成', 'rewards.claimQueued': 'Lobster Token 领取已排队', 'static.activeDaysValue': '18 / 30 天', 'static.validRefsValue': '7 / 10 人'
    }
  };
  accountTranslations.ja = Object.assign({}, accountTranslations.en, { 'account.title': 'アカウント概要', 'assets.title': '資産', 'positions.title': 'ポジション', 'rewards.title': 'Lobster 報酬', 'rewards.eyebrow': '', 'account.eyebrow': '', 'assets.eyebrow': '', 'positions.eyebrow': '', 'account.depositWithdraw': '入金 / 出金', 'positions.continueTrading': '取引を続ける', 'rewards.claimUnlocked': 'Lobster Token を請求', 'account.currentPositions': '現在のポジション', 'account.quickActions': 'クイック操作', 'assets.deposit': 'USDT 入金', 'assets.withdrawal': 'USDT 出金', 'assets.ledgerEntries': '資産履歴', 'assets.withdrawStatus': '出金ステータス', 'rewards.unlockConditions': '解除条件', 'rewards.ledger': '報酬履歴', 'rewards.tasks': 'タスク', 'table.market': 'マーケット', 'table.pick': '選択', 'table.amount': '金額', 'table.status': 'ステータス', 'common.copy': 'コピー', 'common.copied': 'コピー済み', 'common.done': '完了', 'common.open': '未完了' });
  accountTranslations.ko = Object.assign({}, accountTranslations.en, { 'account.title': '계정 개요', 'assets.title': '자산', 'positions.title': '포지션', 'rewards.title': 'Lobster 리워드', 'rewards.eyebrow': '', 'account.eyebrow': '', 'assets.eyebrow': '', 'positions.eyebrow': '', 'account.depositWithdraw': '입금 / 출금', 'positions.continueTrading': '거래 계속하기', 'rewards.claimUnlocked': 'Lobster Token 수령', 'account.currentPositions': '현재 포지션', 'account.quickActions': '빠른 작업', 'assets.deposit': 'USDT 입금', 'assets.withdrawal': 'USDT 출금', 'assets.ledgerEntries': '자산 내역', 'assets.withdrawStatus': '출금 상태', 'rewards.unlockConditions': '잠금 해제 조건', 'rewards.ledger': '리워드 내역', 'rewards.tasks': '작업', 'table.market': '마켓', 'table.pick': '선택', 'table.amount': '금액', 'table.status': '상태', 'common.copy': '복사', 'common.copied': '복사됨', 'common.done': '완료', 'common.open': '미완료' });
  accountTranslations.vi = Object.assign({}, accountTranslations.en, { 'account.title': 'Tổng quan tài khoản', 'assets.title': 'Tài sản', 'positions.title': 'Vị thế', 'rewards.title': 'Thưởng Lobster', 'rewards.eyebrow': '', 'account.eyebrow': '', 'assets.eyebrow': '', 'positions.eyebrow': '', 'account.depositWithdraw': 'Nạp / Rút', 'positions.continueTrading': 'Tiếp tục giao dịch', 'rewards.claimUnlocked': 'Nhận Lobster Token', 'account.currentPositions': 'Vị thế hiện tại', 'account.quickActions': 'Thao tác nhanh', 'assets.deposit': 'Nạp USDT', 'assets.withdrawal': 'Rút USDT', 'assets.ledgerEntries': 'Lịch sử tài sản', 'assets.withdrawStatus': 'Trạng thái rút', 'rewards.unlockConditions': 'Điều kiện mở khóa', 'rewards.ledger': 'Sổ thưởng', 'rewards.tasks': 'Nhiệm vụ', 'table.market': 'Thị trường', 'table.pick': 'Lựa chọn', 'table.amount': 'Số tiền', 'table.status': 'Trạng thái', 'common.copy': 'Sao chép', 'common.copied': 'Đã sao chép', 'common.done': 'Hoàn tất', 'common.open': 'Chưa xong' });
  accountTranslations.id = Object.assign({}, accountTranslations.en, { 'account.title': 'Ringkasan akun', 'assets.title': 'Aset', 'positions.title': 'Posisi', 'rewards.title': 'Reward Lobster', 'rewards.eyebrow': '', 'account.eyebrow': '', 'assets.eyebrow': '', 'positions.eyebrow': '', 'account.depositWithdraw': 'Deposit / Tarik', 'positions.continueTrading': 'Lanjut trading', 'rewards.claimUnlocked': 'Klaim Lobster Token', 'account.currentPositions': 'Posisi saat ini', 'account.quickActions': 'Aksi cepat', 'assets.deposit': 'Deposit USDT', 'assets.withdrawal': 'Penarikan USDT', 'assets.ledgerEntries': 'Riwayat aset', 'assets.withdrawStatus': 'Status penarikan', 'rewards.unlockConditions': 'Syarat unlock', 'rewards.ledger': 'Buku reward', 'rewards.tasks': 'Tugas', 'table.market': 'Pasar', 'table.pick': 'Pilihan', 'table.amount': 'Jumlah', 'table.status': 'Status', 'common.copy': 'Salin', 'common.copied': 'Disalin', 'common.done': 'Selesai', 'common.open': 'Belum selesai' });
  Object.assign(accountTranslations.ja, { 'account.subtitle': 'USDT 残高、予測ポジション、GreenX 金庫、Alpha 保険、Lobster Token の解除進捗を管理します。', 'assets.subtitle': 'USDT の入金、出金、利用可能残高、金庫資金、請求可能な支払いを管理します。', 'positions.subtitle': 'サッカーの YES/NO、固定オッズの正確スコア、暗号資産 Up/Down、想定リターン、保険カバーを確認できます。', 'rewards.subtitle': '取引マイニング、金庫ブースト、Alpha 保険ブースト、紹介、タスク報酬をここに集約します。Lobster Token は解除条件を満たすまでロックされます。', 'account.availableBalance': '利用可能残高', 'account.frozenOrders': '注文中の凍結額', 'account.vaultBalance': '金庫残高', 'account.unlock': 'Lobster Token 解除', 'account.cumulativeVolume': '累計取引量', 'account.activeDays': 'アクティブ日数', 'account.vaultLock': '金庫ロック', 'account.unlockableAmount': '解除可能額', 'assets.available': '利用可能', 'assets.frozen': '凍結中', 'assets.vault': '金庫', 'assets.claimable': '請求可能', 'assets.depositAddress': '入金アドレス', 'assets.confirmDepositAmount': '入金額を確認', 'assets.withdrawAddress': '出金アドレス', 'assets.submitWithdrawal': '出金を申請', 'positions.totalStaked': '累計投入額', 'positions.potentialReturn': '想定リターン', 'positions.insuredAmount': '保険対象額', 'positions.open': '未決済', 'positions.settled': '決済済み', 'positions.insured': '保険付き', 'rewards.totalCredits': 'Lobster Token 合計', 'rewards.unlocked': '解除済み', 'rewards.todayAdded': '本日の追加', 'rewards.referralRebate': '紹介リベート', 'rewards.tradingVolume': '累計取引量', 'rewards.vaultDuration': '金庫残高の継続期間', 'rewards.validReferrals': '有効な紹介', 'rewards.miningWeights': 'マイニング比率', 'rewards.referralLink': '紹介リンク', 'rewards.leaderboard': 'ランキング', 'rewards.you': 'あなた', 'rewards.openPositions': 'ポジションを開く', 'rewards.vaultDays': '18 日', 'auth.backMarkets': 'マーケットへ戻る', 'table.source': 'ソース', 'table.multiplier': '倍率', 'table.time': '時刻', 'reward.orderReward': '注文報酬', 'reward.vaultBoost': 'GreenX 金庫ブースト', 'reward.insuranceBoost': 'Alpha 保険ブースト', 'reward.referralRebate': '紹介リベート', 'reward.daily': '毎日', 'reward.campaign': 'キャンペーン', 'task.firstOrder': '最初の予測注文を行う', 'task.tradeVolume': '取引量 10,000 USDT を達成', 'task.depositVault': 'GreenX 金庫に預け入れる', 'task.useInsurance': 'Alpha 保険を利用する', 'task.inVault': '金庫内', 'task.insuranceNodes': '保険ノード', 'rewards.tradingFee': '取引手数料', 'rewards.marketActivity': '市場アクティビティ', 'rewards.insuranceParticipation': '保険参加', 'rewards.referralNote': '招待されたユーザーが入金と初回取引を完了すると、有効な紹介としてカウントされます。', 'static.activeDaysValue': '18 / 30 日', 'static.validRefsValue': '7 / 10 人' });
  Object.assign(accountTranslations.ko, { 'account.subtitle': 'USDT 잔액, 예측 포지션, GreenX 금고, Alpha 보험, Lobster Token 잠금 해제 진행 상황을 관리합니다.', 'assets.subtitle': 'USDT 입금, 출금, 사용 가능 잔액, 금고 자금, 수령 가능 금액을 관리합니다.', 'positions.subtitle': '축구 YES/NO, 고정 배당 정확한 스코어, 암호화폐 Up/Down 거래, 예상 수익과 보험 보장을 확인합니다.', 'rewards.subtitle': '거래 마이닝, 금고 부스트, Alpha 보험 부스트, 추천 및 작업 리워드가 이곳에 집계됩니다. Lobster Token는 조건 충족 전까지 잠깁니다.', 'account.availableBalance': '사용 가능 잔액', 'account.frozenOrders': '주문 동결', 'account.vaultBalance': '금고 잔액', 'account.unlock': 'Lobster Token 잠금 해제', 'account.cumulativeVolume': '누적 거래량', 'account.activeDays': '활동 일수', 'account.vaultLock': '금고 잠금', 'account.unlockableAmount': '잠금 해제 가능 금액', 'assets.available': '사용 가능', 'assets.frozen': '동결', 'assets.vault': '금고', 'assets.claimable': '수령 가능', 'assets.depositAddress': '입금 주소', 'assets.confirmDepositAmount': '입금 금액 확인', 'assets.withdrawAddress': '출금 주소', 'assets.submitWithdrawal': '출금 신청', 'positions.totalStaked': '총 투입액', 'positions.potentialReturn': '예상 수익', 'positions.insuredAmount': '보험 적용 금액', 'positions.open': '미정산', 'positions.settled': '정산됨', 'positions.insured': '보험 적용', 'rewards.totalCredits': 'Lobster Token 합계', 'rewards.unlocked': '잠금 해제됨', 'rewards.todayAdded': '오늘 추가', 'rewards.referralRebate': '추천 리베이트', 'rewards.tradingVolume': '누적 거래량', 'rewards.vaultDuration': '금고 잔액 유지 기간', 'rewards.validReferrals': '유효 추천', 'rewards.miningWeights': '마이닝 가중치', 'rewards.referralLink': '추천 링크', 'rewards.leaderboard': '리더보드', 'rewards.you': '나', 'rewards.openPositions': '포지션 열기', 'table.source': '출처', 'table.multiplier': '배수', 'table.time': '시간', 'reward.orderReward': '주문 리워드', 'reward.vaultBoost': 'GreenX 금고 부스트', 'reward.insuranceBoost': 'Alpha 보험 부스트', 'reward.referralRebate': '추천 리베이트', 'reward.daily': '매일', 'reward.campaign': '캠페인', 'static.activeDaysValue': '18 / 30일', 'static.validRefsValue': '7 / 10명' });
  Object.assign(accountTranslations.vi, { 'account.subtitle': 'Quản lý số dư USDT, vị thế dự đoán, GreenX Vault, Alpha Insurance và tiến độ mở khóa Lobster Token.', 'assets.subtitle': 'Quản lý nạp, rút USDT, số dư khả dụng, tiền trong vault và khoản có thể nhận.', 'positions.subtitle': 'Theo dõi YES/NO bóng đá, tỷ số chính xác theo odds cố định, giao dịch crypto Up/Down, lợi nhuận tiềm năng và bảo hiểm.', 'rewards.subtitle': 'Trading mining, boost vault, boost Alpha Insurance, giới thiệu và nhiệm vụ được tổng hợp tại đây. Lobster Token bị khóa cho đến khi đạt điều kiện mở khóa.', 'account.availableBalance': 'Số dư khả dụng', 'account.frozenOrders': 'Đang khóa trong lệnh', 'account.vaultBalance': 'Số dư vault', 'account.unlock': 'Mở khóa Lobster Token', 'account.cumulativeVolume': 'Khối lượng tích lũy', 'account.activeDays': 'Ngày hoạt động', 'account.vaultLock': 'Khóa vault', 'account.unlockableAmount': 'Có thể mở khóa', 'assets.available': 'Khả dụng', 'assets.frozen': 'Đang khóa', 'assets.vault': 'Vault', 'assets.claimable': 'Có thể nhận', 'assets.depositAddress': 'Địa chỉ nạp', 'assets.confirmDepositAmount': 'Xác nhận số tiền nạp', 'assets.withdrawAddress': 'Địa chỉ rút', 'assets.submitWithdrawal': 'Gửi yêu cầu rút', 'positions.totalStaked': 'Tổng đã đặt', 'positions.potentialReturn': 'Lợi nhuận tiềm năng', 'positions.insuredAmount': 'Số tiền bảo hiểm', 'positions.open': 'Đang mở', 'positions.settled': 'Đã quyết toán', 'positions.insured': 'Có bảo hiểm', 'rewards.totalCredits': 'Tổng Lobster Token', 'rewards.unlocked': 'Đã mở khóa', 'rewards.todayAdded': 'Thêm hôm nay', 'rewards.referralRebate': 'Hoàn thưởng giới thiệu', 'rewards.tradingVolume': 'Khối lượng giao dịch tích lũy', 'rewards.validReferrals': 'Giới thiệu hợp lệ', 'rewards.miningWeights': 'Trọng số mining', 'rewards.referralLink': 'Liên kết giới thiệu', 'rewards.leaderboard': 'Bảng xếp hạng', 'rewards.you': 'Bạn' });
  Object.assign(accountTranslations.vi, { 'rewards.vaultDuration': 'Thời lượng số dư vault', 'rewards.openPositions': 'Mở vị thế', 'table.source': 'Nguồn', 'table.multiplier': 'Hệ số', 'table.time': 'Thời gian', 'reward.orderReward': 'Thưởng lệnh', 'reward.vaultBoost': 'Boost GreenX Vault', 'reward.insuranceBoost': 'Boost Alpha Insurance', 'reward.referralRebate': 'Hoàn thưởng giới thiệu', 'reward.daily': 'Hằng ngày', 'reward.campaign': 'Chiến dịch', 'static.activeDaysValue': '18 / 30 ngày', 'static.validRefsValue': '7 / 10 người dùng' });
  Object.assign(accountTranslations.id, { 'account.subtitle': 'Kelola saldo USDT, posisi prediksi, GreenX Vault, Alpha Insurance, dan progres unlock Lobster Token.', 'assets.subtitle': 'Kelola deposit, penarikan USDT, saldo tersedia, dana vault, dan payout yang dapat diklaim.', 'positions.subtitle': 'Pantau YES/NO sepak bola, skor tepat fixed-odds, trading crypto Up/Down, potensi hasil, dan proteksi asuransi.', 'rewards.subtitle': 'Trading mining, boost vault, boost Alpha Insurance, referral, dan reward tugas dikumpulkan di sini. Lobster Token tetap terkunci sampai syarat unlock terpenuhi.', 'account.availableBalance': 'Saldo tersedia', 'account.frozenOrders': 'Dibekukan di order', 'account.vaultBalance': 'Saldo vault', 'account.unlock': 'Unlock Lobster Token', 'account.cumulativeVolume': 'Volume kumulatif', 'account.activeDays': 'Hari aktif', 'account.vaultLock': 'Lock vault', 'account.unlockableAmount': 'Jumlah dapat di-unlock', 'assets.available': 'Tersedia', 'assets.frozen': 'Dibekukan', 'assets.vault': 'Vault', 'assets.claimable': 'Dapat diklaim', 'assets.depositAddress': 'Alamat deposit', 'assets.confirmDepositAmount': 'Konfirmasi jumlah deposit', 'assets.withdrawAddress': 'Alamat penarikan', 'assets.submitWithdrawal': 'Kirim penarikan', 'positions.totalStaked': 'Total stake', 'positions.potentialReturn': 'Potensi hasil', 'positions.insuredAmount': 'Jumlah diasuransikan', 'positions.open': 'Terbuka', 'positions.settled': 'Selesai', 'positions.insured': 'Diasuransikan', 'rewards.totalCredits': 'Total Lobster Token', 'rewards.unlocked': 'Ter-unlock', 'rewards.todayAdded': 'Ditambah hari ini', 'rewards.referralRebate': 'Rebate referral', 'rewards.tradingVolume': 'Volume trading kumulatif', 'rewards.validReferrals': 'Referral valid', 'rewards.miningWeights': 'Bobot mining', 'rewards.referralLink': 'Link referral', 'rewards.leaderboard': 'Papan peringkat', 'rewards.you': 'Anda' });
  Object.assign(accountTranslations.id, { 'rewards.vaultDuration': 'Durasi saldo vault', 'rewards.openPositions': 'Buka posisi', 'table.source': 'Sumber', 'table.multiplier': 'Pengali', 'table.time': 'Waktu', 'reward.orderReward': 'Reward order', 'reward.vaultBoost': 'Boost GreenX Vault', 'reward.insuranceBoost': 'Boost Alpha Insurance', 'reward.referralRebate': 'Rebate referral', 'reward.daily': 'Harian', 'reward.campaign': 'Kampanye', 'static.activeDaysValue': '18 / 30 hari', 'static.validRefsValue': '7 / 10 pengguna' });
  const greenxOverrides = {
    en: {
      'account.subtitle': 'Manage USDT balances, GreenX lobster level, Lobster Token consumption, vault deposits, Alpha Insurance, and prediction positions.',
      'account.available': 'Available USDT', 'account.greenxLevel': 'GreenX lobster level', 'account.lobsterToken': 'Lobster Token',
      'account.greenxTitle': 'GreenX wallet sync', 'account.airdrop': 'Lobster airdrop', 'account.claimReady': 'Ready to claim',
      'account.nextLevelValue': '50,000 USDT · Royal Lobster',
      'account.claimLobster': 'Claim Lobster Token', 'account.aiTitle': 'AI prediction assistant',
      'account.aiMarketValue': 'Football volatility is moderate; prefer smaller stake sizes.',
      'account.aiVaultValue': '30-day lock has the best liquidity-adjusted return today.',
      'account.lobsterConsumption': 'Lobster Token usage', 'account.lobsterPreferred': 'Lobster preferred',
      'account.vaultHint': 'Upgrade lobster level with USDT deposits', 'account.insuranceHint': 'Use Lobster Token for cover',
      'vault.title': 'Vault Details', 'vault.subtitle': 'Deploy USDT to an AI prediction agent. The agent evaluates event markets, places risk-controlled prediction orders, and returns realized yield to the vault.',
      'vault.termsValue': '7 / 30 / 90 / 180 / 360 days',
      'vault.ledgerDeposit': 'Vault deposit', 'vault.ledgerWithdraw': 'Vault withdraw',
      'vault.depositNote': 'Deploys USDT to the AI prediction agent for a {days}-day cycle.', 'vault.withdrawNote': 'Withdraws unlocked USDT from the AI Agent Vault back to available balance.',
      'task.depositVault': 'Deposit into GreenX Vault', 'reward.vaultBoost': 'GreenX Vault boost'
    },
    'zh-CN': {
      'account.subtitle': '管理 USDT 余额、GreenX 龙虾等级、Lobster Token 消耗、金库存款、Alpha 保险和预测持仓。',
      'account.available': '可用 USDT', 'account.greenxLevel': 'GreenX 龙虾等级', 'account.lobsterToken': 'Lobster Token',
      'account.greenxTitle': 'GreenX 钱包同步', 'account.airdrop': '龙虾空投', 'account.claimReady': '可领取',
      'account.nextLevelValue': '50,000 USDT · 皇龙虾',
      'account.claimLobster': '领取 Lobster Token', 'account.aiTitle': 'AI 预测助手',
      'account.aiMarketValue': '足球波动中等，建议控制单笔下注金额。',
      'account.aiVaultValue': '今日 30 天锁仓在收益和流动性之间更均衡。',
      'account.lobsterConsumption': 'Lobster Token 消耗', 'account.lobsterPreferred': '优先使用 Lobster',
      'account.vaultHint': '用 USDT 存款升级龙虾等级', 'account.insuranceHint': '使用 Lobster Token 购买保障',
      'vault.title': '金库详情', 'vault.subtitle': '将 USDT 部署给 AI 预测 Agent。Agent 会分析事件预测市场，执行风控下注，并将已实现收益回到金库。',
      'vault.termsValue': '7 / 30 / 90 / 180 / 360 天',
      'vault.ledgerDeposit': '金库存入', 'vault.ledgerWithdraw': '金库取出',
      'vault.depositNote': '将 USDT 部署给 AI 预测 Agent，运行 {days} 天周期。',
      'vault.withdrawNote': '将已解锁 USDT 从 AI Agent 金库转回可用余额。',
      'task.depositVault': '存入 GreenX 金库', 'reward.vaultBoost': 'GreenX 金库加成'
    }
  };
  Object.entries(greenxOverrides).forEach(([locale, values]) => Object.assign(accountTranslations[locale], values));
  const lobsterTokenOverrides = {
    en: {
      'account.subtitle': 'Manage USDT balances, GreenX lobster level, Lobster Token rewards and consumption, vault deposits, Alpha Insurance, and prediction positions.',
      'account.unlock': 'Lobster Token unlock', 'account.lobsterReward': 'Lobster Token',
      'account.rewardsDesc': 'Lobster Token rewards for every settled trade', 'account.vaultDesc': 'GreenX-connected USDT vault and lobster level upgrades',
      'account.specialMarkets': 'Lobster-only markets', 'account.lobsterRequired': 'Lobster required',
      'rewards.title': 'Lobster Token Rewards',
      'rewards.subtitle': 'Every prediction trade can earn Lobster Token whether the position wins or loses. Fees, Alpha Insurance, lobster-only markets, and vault staking acceleration all consume Lobster Token.',
      'rewards.claimUnlocked': 'Claim Lobster Token', 'rewards.totalCredits': 'Total Lobster Token',
      'state.noRewards': 'No rewards yet. Trade, deposit into GreenX Vault, or invite users to earn Lobster Token.',
      'reward.orderReward': 'Trade reward', 'reward.vaultBoost': 'GreenX Vault boost', 'reward.insuranceBoost': 'Alpha Insurance boost',
      'task.firstOrder': 'Place first prediction order', 'task.depositVault': 'Deposit into GreenX Vault',
      'table.lobsterReward': 'Lobster Token', 'table.credits': 'Lobster Token',
      'order.lobsterReward': 'Lobster Token',
      'order.note': 'Prediction markets use USDT only. Winning payouts return to your USDT balance; every valid trade can earn Lobster Token.',
      'vault.title': 'Vault Details',
      'vault.subtitle': 'GreenX Vault is fully connected to the lobster-level channel. Deploy USDT to the AI prediction agent, stake Lobster Token to accelerate upgrades, and keep manual prediction trading independent.',
      'vault.levelRuleValue': 'Cumulative valid USDT vault deposits upgrade the same lobster level used by GreenX',
      'vault.marketSeparateValue': 'Manual prediction trading remains independent and uses USDT only',
      'vault.lobsterBoostValue': 'Staking Lobster Token accelerates lobster-level upgrades and extends level validity',
      'insurance.title': 'Alpha Insurance',
      'insurance.step1Body': 'Pay premium with Lobster Token when placing the prediction order',
      'insurance.ruleBody': 'Alpha Insurance consumes Lobster Token for premiums. Payout nodes are internal credentials, not NFTs, and payouts depend on settlement result, pool health, user risk score, and order type.'
    },
    'zh-CN': {
      'account.subtitle': '管理 USDT 余额、GreenX 龙虾等级、Lobster Token 奖励与消耗、金库存款、Alpha 保险和预测持仓。',
      'account.available': '可用 USDT', 'account.greenxLevel': 'GreenX 龙虾等级', 'account.lobsterToken': 'Lobster Token',
      'account.greenxTitle': 'GreenX 钱包同步', 'account.airdrop': '龙虾空投', 'account.claimReady': '可领取',
      'account.nextLevelValue': '50,000 USDT · 皇龙虾',
      'account.claimLobster': '领取 Lobster Token', 'account.aiTitle': 'AI 预测助手',
      'account.aiMarketValue': '足球波动中等，建议控制单笔下注金额。',
      'account.aiVaultValue': '今日 30 天锁仓在收益和流动性之间更均衡。',
      'account.lobsterConsumption': 'Lobster Token 消耗', 'account.lobsterPreferred': '优先使用 Lobster Token',
      'account.specialMarkets': '龙虾专场', 'account.lobsterRequired': '需消耗 Lobster Token',
      'account.vaultHint': '用 USDT 存款升级龙虾等级', 'account.insuranceHint': '使用 Lobster Token 购买保障',
      'account.unlock': 'Lobster Token 解锁', 'account.lobsterReward': 'Lobster Token',
      'account.rewardsDesc': '输赢都有 Lobster Token 奖励', 'account.vaultDesc': '与 GreenX 打通的 USDT 金库和龙虾等级升级',
      'rewards.title': 'Lobster Token 奖励',
      'rewards.subtitle': '每一笔有效预测交易无论输赢都可获得 Lobster Token。手续费、Alpha 保险、龙虾专场和金库质押加速都会消耗 Lobster Token。',
      'rewards.claimUnlocked': '领取 Lobster Token', 'rewards.totalCredits': 'Lobster Token 总额',
      'state.noRewards': '暂无奖励。交易、存入 GreenX 金库或邀请用户可获得 Lobster Token。',
      'reward.orderReward': '交易奖励', 'reward.vaultBoost': 'GreenX 金库加成', 'reward.insuranceBoost': 'Alpha 保险加成',
      'task.firstOrder': '完成首笔预测订单', 'task.depositVault': '存入 GreenX 金库',
      'table.lobsterReward': 'Lobster Token', 'table.credits': 'Lobster Token',
      'order.lobsterReward': 'Lobster Token',
      'order.note': '预测市场只使用 USDT 下单。盈利赔付返回 USDT 余额，每笔有效交易无论输赢都可获得 Lobster Token。',
      'vault.title': '金库详情',
      'vault.subtitle': '金库与 GreenX 龙虾等级通道完全打通。用户部署 USDT 给 AI 预测 Agent，并可质押 Lobster Token 加速升级；手动预测交易保持独立。',
      'vault.termsValue': '7 / 30 / 90 / 180 / 360 天',
      'vault.levelRuleValue': '累计有效 USDT 金库存款会升级与 GreenX 共用的龙虾等级',
      'vault.marketSeparateValue': '用户手动预测交易完全独立，只使用 USDT 下单',
      'vault.lobsterBoostValue': '质押 Lobster Token 可加速龙虾等级升级或延长等级有效期',
      'vault.ledgerDeposit': '金库存入', 'vault.ledgerWithdraw': '金库取出',
      'vault.depositNote': '将 USDT 部署给 AI 预测 Agent，运行 {days} 天周期。',
      'vault.withdrawNote': '将已解锁 USDT 从 AI Agent 金库转回可用余额。',
      'insurance.title': 'Alpha 保险',
      'insurance.step1Body': '下单时使用 Lobster Token 支付保费',
      'insurance.ruleBody': 'Alpha 保险保费消耗 Lobster Token。保险节点是内部赔付凭证，不是 NFT，不能转让。赔付取决于结算结果、保险池健康度、用户风险评分和订单类型。'
    },
    ja: {
      'rewards.title': 'Lobster Token 報酬', 'rewards.claimUnlocked': 'Lobster Token を請求',
      'rewards.subtitle': '有効な予測取引は、勝敗にかかわらず Lobster Token 報酬の対象です。手数料、Alpha 保険、専用マーケット、金庫ステーキング加速は Lobster Token を消費します。',
      'order.lobsterReward': 'Lobster Token', 'insurance.title': 'Alpha 保険', 'vault.title': '金庫詳細'
    },
    ko: {
      'rewards.title': 'Lobster Token 리워드', 'rewards.claimUnlocked': 'Lobster Token 수령',
      'rewards.subtitle': '유효한 예측 거래는 승패와 관계없이 Lobster Token 보상을 받을 수 있습니다. 수수료, Alpha 보험, 전용 마켓, 금고 스테이킹 가속은 Lobster Token을 소모합니다.',
      'order.lobsterReward': 'Lobster Token', 'insurance.title': 'Alpha 보험', 'vault.title': '금고 상세'
    },
    vi: {
      'rewards.title': 'Thưởng Lobster Token', 'rewards.claimUnlocked': 'Nhận Lobster Token',
      'rewards.subtitle': 'Mỗi giao dịch dự đoán hợp lệ đều có thể nhận Lobster Token dù thắng hay thua. Phí, Alpha Insurance, thị trường riêng và tăng tốc staking vault đều tiêu thụ Lobster Token.',
      'order.lobsterReward': 'Lobster Token', 'insurance.title': 'Alpha Insurance', 'vault.title': 'Chi tiết Vault'
    },
    id: {
      'rewards.title': 'Reward Lobster Token', 'rewards.claimUnlocked': 'Klaim Lobster Token',
      'rewards.subtitle': 'Setiap trading prediksi valid dapat memperoleh Lobster Token baik menang maupun kalah. Fee, Alpha Insurance, market khusus, dan akselerasi staking vault memakai Lobster Token.',
      'order.lobsterReward': 'Lobster Token', 'insurance.title': 'Alpha Insurance', 'vault.title': 'Detail Vault'
    }
  };
  Object.entries(lobsterTokenOverrides).forEach(([locale, values]) => Object.assign(accountTranslations[locale], values));
  ...
  Object.assign(adminTranslations['zh-CN'], {
    'admin.brand': '后台', 'admin.nav.operations': '运营', 'admin.nav.dashboard': '看板', 'admin.nav.football': '足球采集', 'admin.nav.markets': '市场',
    'admin.nav.odds': '赔率', 'admin.nav.settlement': '结算', 'admin.nav.withdrawals': '提现', 'admin.nav.risk': '风控', 'admin.nav.exposure': '敞口',
    'admin.nav.ledger': '账务核对', 'admin.nav.insurance': '保险池', 'admin.search': '搜索用户、市场、交易编号', 'admin.openSite': '打开前台',
    'admin.operator': '运营控制台', 'admin.eyebrow': '运营管理', 'admin.title': '运营看板',
    'admin.subtitle': '管理市场创建、固定赔率、比分盘口、赛果结算、账务核对、提现审核和风险控制。',
    'admin.createMarket': '创建市场', 'admin.metric.volume': '24小时交易量', 'admin.metric.exposure': '未结算敞口',
    'admin.metric.vault': '金库 TVL', 'admin.metric.pool': '保险池', 'admin.metric.withdrawals': '待处理提现',
    'admin.football.title': '足球比赛采集', 'admin.football.subtitle': '自动采集 Polymarket、Kalshi 和 API-Football 的足球比赛，去重后发布到足球频道。',
    'admin.preview': '预览', 'admin.runNow': '立即运行', 'admin.publishSelected': '发布选中',
    'admin.sources': '来源', 'admin.sourcesValue': 'Polymarket 足球 / Kalshi 足球 / API-Football',
    'admin.autoCollection': '自动采集', 'admin.waitingRun': '等待首次运行', 'admin.autoOdds': '自动赔率',
    'admin.autoOddsValue': 'Poisson + Dixon-Coles 模型，25 个比分盘口，YES/NO 自动重算',
    'admin.autoSettlement': '自动结算', 'admin.autoSettlementValue': '比赛结束窗口后 30 分钟拉取赛果，并结算未结订单',
    'admin.markets.title': '市场', 'admin.export': '导出', 'admin.settlement.title': '结算队列', 'admin.runOracle': '运行预言机',
    'admin.withdrawals.title': '提现审核', 'admin.refresh': '刷新', 'admin.exposure.title': '风险敞口',
    'admin.table.market': '市场', 'admin.table.type': '类型', 'admin.table.volume': '交易量', 'admin.table.exposure': '敞口',
    'admin.table.status': '状态', 'admin.table.result': '结果', 'admin.table.source': '来源', 'admin.table.userAddress': '用户 / 地址',
    'admin.table.amount': '金额', 'admin.table.risk': '风险', 'admin.table.stake': '下注额', 'admin.table.potentialPayout': '潜在赔付',
    'admin.create.title': '创建市场', 'admin.field.marketTitle': '市场标题', 'admin.field.league': '联赛', 'admin.field.type': '类型',
    'admin.type.football': '足球', 'admin.type.crypto': '加密', 'admin.field.homeUp': '主队 / 上涨', 'admin.field.awayDown': '客队 / 下跌',
    'admin.field.homeYes': '主胜 YES', 'admin.field.drawYes': '平局 YES', 'admin.field.awayYes': '客胜 YES', 'admin.saveDraft': '保存草稿市场',
    'admin.odds.title': '赔率编辑', 'admin.autoReprice': '自动重算足球赔率', 'admin.publishResultOdds': '发布胜平负赔率',
    'admin.score.title': '比分赔率', 'admin.score.lines': '25 个盘口', 'admin.publishScoreOdds': '发布比分赔率',
    'admin.audit.title': '账务核对', 'admin.audit.internal': '平台余额', 'admin.audit.custody': '链上托管', 'admin.audit.diff': '差额',
    'admin.audit.last': '最后核对', 'admin.riskLimits.title': '风控限额', 'admin.riskLimits.pretrade': '交易前',
    'admin.riskLimits.maxOrder': '单笔最高', 'admin.riskLimits.userOpenPayout': '用户未结赔付', 'admin.riskLimits.marketPayout': '市场赔付',
    'admin.riskLimits.scorePayout': '比分赔付', 'admin.riskLimits.save': '保存风控限额', 'admin.log.title': '运营日志'
  });
  ...
  const exact = {
    'zh-CN': {
      ...
      'No rewards yet. Trade, deposit into vault, or invite users to earn Lobster Token.': '暂无奖励。交易、存入金库或邀请用户可获得 Lobster Token。',
      'Open market': '可交易市场', 'no sell before settlement': '结算前不可卖出', 'Fixed odds score market; no sell before settlement': '固定赔率比分市场，结算前不可卖出',
      'Order reward': '订单奖励', 'GreenX Vault boost': 'GreenX 金库加成', 'Alpha Insurance boost': 'Alpha 保险加成', 'Referral rebate': '邀请返佣',
